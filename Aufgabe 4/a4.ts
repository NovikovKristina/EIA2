namespace Aufgabe_4 {
    ...
    function init(_event: Event): void {
        ...
        // Wiese
        function wiese(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            crc2.beginPath();
        ...
        // Himmel
        function himmel(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            crc2.beginPath();
        ...
        // Berge 1-3
        function bergEins(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            crc2.beginPath();
        ...
        function bergDrei(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            crc2.beginPath();
            crc2.fillStyle = _fillColor;
            crc2.strokeStyle = _strokeColor;
            crc2.moveTo(_x + 0, _y + 0);
        ...
        // Wolken 1 und 2
        function wolkeEins(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // linker Bogen
            crc2.beginPath();
        ...
        function wolkeZwei(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // linker Bogen
            crc2.beginPath();
        ...
        // Sonne
        function sonne(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            crc2.beginPath();
        ...
        // Tannen 1 und 2
        function tanneEins(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // Baumstamm
            crc2.beginPath();
        ...
        function tanneZwei(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // Baumstamm
            crc2.beginPath();
            crc2.fillStyle = "#5F4C0B";
            crc2.strokeStyle = "#5F4COB";
        ...
        function blumeEins(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // linke Blüte
            crc2.beginPath();
        ...
        function blumeZwei(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // linke Blüte
            crc2.beginPath();
        ...
        function blumeDrei(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
            // linke obere Blüte
            crc2.beginPath();
